...
window.addEventListener('load', function(event) {
	...
	for(var i=0;i<jobsList.length;i++) {
		...
		var html = '<h3>Job #' + jobsList[i] + '</h3><div><img class="jobPic" src="' + 'img/food.png' + '"><div class="jobContactInfo">' + 'Name: ' + 'Jordan Silver' + '<br>Phone: ' + 'phonenumbergoeshere' + '<br>Email: ' + 'jcsilver@smu.edu' + '<br>Location: ' + 'College Station AKA middle of nowhere podunk piece of shit town' + '</div><div class="jobDashPrice">' + '$' + '5' + '</div><br><div class="jobMap">' + '**Map not implemented**' + '</div><div class="jobNotes">' + 'Here is the description for Job #' + jobsList[i] + '!</div><input type="button" class="cancelJob leftButton" value="Cancel Job"><input type="button" class="jobCompleted rightButton" value="Job Completed"</div>';
